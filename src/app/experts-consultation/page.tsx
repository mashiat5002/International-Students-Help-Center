...
const features = [
  {
    title: 'Easily Request Expert Help',
    description: 'Open a simple form to connect with an expert for personalized guidance on your academic journey.',
    image: '/student-clicking-to-open-request-form.png',
    iconBg: 'bg-purple-100',
    icon: '🤖',
  },
  {
    title: 'Schedule a Meeting with Experts',
    description: 'Book one-on-one sessions with our experts at your convenience, ensuring you get the support you need, when you need it.',
    image: '/meeting-request-form.png',
    iconBg: 'bg-blue-100',
    icon: '🦾',
  },
  {
    title: 'Expert Dashboard',
    description: 'Experts can manage requests, view schedules, and provide timely assistance to students from a unified dashboard.',
    image: '/expert-landing-page.png',
    iconBg: 'bg-green-100',
    icon: '💡',
  },
  {
    title: 'Track Your Meeting Requests',
    description: 'Stay updated on the status of your meeting requests and never miss an important session.',
    image: '/meeting-requests-list.png',
    iconBg: 'bg-yellow-100',
    icon: '🔗',
  },
  {
    title: 'Organize or Join Seminars',
    description: 'Easily schedule or register for seminars to enhance your learning and connect with peers and experts.',
    image: '/seminar-scheduing-form.png',
    iconBg: 'bg-pink-100',
    icon: '📈',
  },
  {
    title: 'Upcoming Seminars',
    description: 'Browse and join upcoming seminars to expand your knowledge and network with the community.',
    image: '/seminar-upcoming-list.png',
    iconBg: 'bg-pink-100',
    icon: '📅',
  },
];
...
export default function Experts_consultation() {
    ...
    <div className="min-h-screen mt-20 bg-white flex flex-col justify-between overflow-y-hidden">
      ...
      <div>
        ...
        <div className="text-center pt-12 pb-8">
          ...
          <h1 className="text-3xl md:text-4xl font-bold mb-4">Expert Consultation Assistance in International Students Help Center</h1>
          <p className="text-gray-500 max-w-xl mx-auto">Discover how our Experts Consultation features can help you learn, organize, and succeed. Each tool is designed to make your academic journey easier and more effective.</p>
        </div>
        {/* Features */}
          ...
          <div className="max-w-5xl mx-auto px-4 flex flex-col md:flex-row items-center gap-10">
            ...
            >
              <div className=" rounded-2xl overflow-hidden  w-full max-w-md aspect-video  flex items-center justify-center">
                  <img src={"/expert-landing-page.png"} alt={"Expert Dashboard Preview"} className="object-contain  w-full h-full" />
                </div>
            </motion.div>
          </div>
        </div>
