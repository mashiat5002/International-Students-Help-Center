...
export  async function POST(req: NextRequest) {
  ...
  if(body.type=="questions"){
    message="Generate exactly 5 questions to understand my ideal study destination. Return the result strictly as a JSON array of strings, with each question properly quoted. Do not include any extra text, formatting, markdown, or explanation. The output must be a valid JSON string.";
