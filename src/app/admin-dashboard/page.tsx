...
const recentClients = [
  { id: '#001', name: 'Leslie Alexander', email: 'leslie@acme.com', phone: '(201) 555-0124', date: '2023-09-14', type: 'Regular', status: 'Active' },
  { id: '#002', name: 'Ronald Richards', email: 'ronald@summit.com', phone: '(907) 555-0101', date: '2023-09-14', type: 'Premium', status: 'Pending' },
  { id: '#003', name: 'Brooklyn Simmons', email: 'brooklyn@brightstar.com', phone: '(209) 555-0104', date: '2023-09-13', type: 'Regular', status: 'Pending' },
  { id: '#004', name: 'Cameron Williamson', email: 'cameron@zenith.com', phone: '(207) 555-0119', date: '2023-09-12', type: 'Premium', status: 'Active' },
  { id: '#005', name: 'Esther Howard', email: 'esther@abstergo.com', phone: '(316) 555-0116', date: '2023-09-12', type: 'Premium', status: 'Active' },
];

const fleetStatus = [
  { id: '#V001', type: 'Truck', location: 'Warehouse A', maintenance: '2023-09-14', status: 'In service', distance: '3,500', fuel: '85%' },
  { id: '#V002', type: 'Van', location: 'Route 1', maintenance: '2023-09-14', status: 'En route', distance: '1,200', fuel: '70%' },
  { id: '#V003', type: 'Truck', location: 'Warehouse B', maintenance: '2023-09-13', status: 'In service', distance: '4,000', fuel: '90%' },
  { id: '#V004', type: 'Ship', location: 'Port 2', maintenance: '2023-09-12', status: 'Out of service', distance: '-', fuel: '-' },
  { id: '#V005', type: 'Van', location: 'Route 3', maintenance: '2023-09-12', status: 'In service', distance: '1,800', fuel: '75%' },
];
